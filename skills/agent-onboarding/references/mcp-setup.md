...
| Situation | Do this |
| --- | --- |
| Generating or modifying Syncfusion code | Install the required skills. MCP is optional. |
...
platform index plus required skills plus public documentation — must work before any key exists.
